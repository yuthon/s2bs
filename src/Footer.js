  ...
  return (
    ...
    <footer className="font-type2 fixed-bottom">
      <span className="about footer-content" data-bs-toggle="modal" data-bs-target="#aboutModal">
        ...
        当ページについて</span>
      <a className="github-link footer-content" href="https://github.com/yuthon/s2bs">
      ...
      <a className="twitter-link footer-content" href="https://twitter.com/PP5rtm">
        <svg xmlns="http://www.w3.org/2000/svg" width="1.2rem" height="1.2rem" viewBox="0 0 512 512">
          {/* <!--! Font Awesome Pro 6.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --> */}
          <path 
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content bg-dark text-white font-type2">
            ...
            <div className="modal-body text-start">
              ...
              <p>制作に当たり第三者の収集したデータや独自に検証した結果を参考にしていますが、小数点数に対する処理の仕方の違いなどによって実際のゲーム内の数値とは異なる場合があることをご了承ください。</p><p>ギアパワー効果などのデータ : <a className="text-white" href="https://leanny.github.io/">Leanさんの収集したデータ</a></p>
