...
export const gears = [
  ...
  {name:"ダテコンタクト", path:DateContact, id:"BS_DateContact", brand:"アロメ",default:specialCharge},
  ...
  {name:"エゾッコメッシュ", path:EzokkoMesh, id:"PT_C0_EzokkoMesh", brand:"エゾッコ",default:quickSuperJump},
  ...
  {name:"キングフリップメッシュ", path:KingFlipMesh, id:"PT_C0_KingFlipMesh", brand:"エンペリー",default:runSpeed},
  // {name:"カイザーカフ", path:KaiserCuff, id:"C0_KingFlipMesh", brand:"エンペリー",default:inkSaverMain},
  {name:"2ラインメッシュ", path:TWOLineMesh, id:"PT_C0_2LineMesh", brand:"クラーゲス",default:specialSaver},
  ...
  {name:"ウールウーニーズクラシック", path:WoolU$ni$zuClassic, id:"PT_C1_WoolU-ni-zuClassic", brand:"クラーゲス",default:comeback},
  ...
  {name:"キャンプキャップ", path:CampCap, id:"PT_C0_CampCap", brand:"シグレ二",default:swimSpeed},
  ...
  {name:"アンコウラバーマスク", path:AnkouRubberMask, id:"EF_M1_AnkouRubberMask", brand:"バトロイカ",default:inkSaverMain},
  {name:"キョンキョンぼう", path:KyonKyonBou, id:"H2_KyonKyonBou", brand:"バトロイカ",default:runSpeed},
  {name:"こうしえんバンダナ", path:KoushienBandana, id:"EF_BN_KoushienBandana", brand:"バトロイカ",default:swimSpeed},
  ...
  {name:"イカスカルマスク", path:IkaSkullMask, id:"EF_BN_IkaSkullMask", brand:"フォーリマ",default:specialSaver},
  // {name:"イカロスHKメット", path:IcarusHKMet, id:"M0_IcarusHKMet", brand:"フォーリマ",default:mpu},
  {name:"イヤーマフ", path:EarMuff, id:"EF_HP_EarMuff", brand:"フォーリマ",default:qr},
  {name:"オクトメットプライズデコ", path:OctoMetPrizeDeko, id:"EF_M1_OctoMetPrizeDeco", brand:"フォーリマ",default:bombDefence},
  ...
  {name:"ウインターボンボン", path:WinterBonBon, id:"EF_KN_WinterBonBon", brand:"ホタックス",default:tenacity},
  ...
  {name:"カモメッシュ", path:KamoMesh, id:"PT_C0_KamoMesh", brand:"ホッコリー",default:swimSpeed},
  {name:"クロヤキフグバンダナ", path:KuroYakifuguBandana, id:"HB_KuroYakifuguBandana", brand:"ホッコリー",default:bombDefence},
  {name:"ジェットキャップ", path:JetCap, id:"PT_C0_JetCap", brand:"ホッコリー",default:specialSaver},
