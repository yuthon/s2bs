...
const weaponStatus = [
  ...
  {name:"ノヴァブラスターベッチュー", sub:"FizzyBomb", special:"アメフラシ", sp:170, weight:"light", path:Luna_2, pathSub:FizzyBomb, pathSpecial:InkStorm},
  ...
  {name:"14式竹筒銃・丙", sub:"FizzyBomb", special:"バブルランチャー", sp:190, weight:"light", path:Bamboo_2, pathSub:FizzyBomb, pathSpecial:BubbleBlower},
  ...
  {name:"スクリュースロッシャーベッチュー", sub:"FizzyBomb", special:"スーパーチャクチ", sp:190, weight:"middle", path:Machine_2, pathSub:FizzyBomb, pathSpecial:SplashDown},
  ...
  {name:"ケルビン525ベッチュー", sub:"FizzyBomb", special:"インクアーマー", sp:180, weight:"middle", path:Glooga_2, pathSub:FizzyBomb, pathSpecial:InkArmor},
