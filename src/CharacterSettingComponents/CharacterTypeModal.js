    ...
    <div className="modal fade" id="characterTypeModal" aria-hidden="true" aria-labelledby="characterTypeModalToggleLabel" tabIndex="-1">
      <div className="modal-dialog">
        <div className="modal-content container">
          ...
          <div className="CT-btn IML" id="IML">
            <svg 
              className="CT-btn-svg" width="240" height="160" viewBox="-500 -142 2300 1300"
              onClick={()=>{
                props.passCharacterType("IML");
                btnSelected("IML");
              }}
              onMouseDown={()=>{
                btnAnimate("IML");
          ...
          <div className="CT-btn OFML" id="OFML">
            <svg 
              className="CT-btn-svg" width="240" height="160" viewBox="-500 -142 2300 1300"
              onClick={()=>{
                props.passCharacterType("OFML");
                btnSelected("OFML");
              }}
              onMouseDown={()=>{
                btnAnimate("OFML");
          ...
          <div className="CT-btn OML" id="OML">
            <svg 
              className="CT-btn-svg" width="240" height="160" viewBox="-500 -142 2300 1300"
              onClick={()=>{
                props.passCharacterType("OML");
                btnSelected("OML");
              }}
              onMouseDown={()=>{
                btnAnimate("OML");
          ...
          <div className="close-btn" data-bs-toggle="modal" data-bs-target="#skinColorModal" data-bs-dismiss="modal">
            <svg 
              className="close-btn-svg" width="240" height="160" viewBox="-500 -142 2300 1300"
            >
              <path 
