...
const SubSlotModal3: FC<SubSlotModalProps> = ({ setAbility }): ReactElement => {
  ...
  return (
    <div className="ability-modal subSlotModal-left font-type2" ref={modalRef} id="subSlotModal3">
