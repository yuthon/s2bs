...
const SubSlotModal8: FC<SubSlotModalProps> = ({ setAbility }): ReactElement => {
  ...
  return (
    <div className="ability-modal subSlotModal-right font-type2" ref={modalRef} id="subSlotModal8">
