...
const MainSlotModal0 = (props) => {
  ...
  return (
    <div className="ability-modal mainSlotModal font-type2" id="mainSlotModal0">
      ...
      <div className="ability-list d-flex flex-wrap">
        ...
        <div
          className="ability-icon ability"
          onClick={()=>{
            props.setAbility({name:"スタートダッシュ", path:openingGanbit});
            }
          }
        >
          <div className="ability-tooltip-container">
        ...
        <div
          className="ability-icon ability"
          onClick={()=>{
            props.setAbility({name:"ラストスパート", path:lde});
            }
          }
        >
          <div className="ability-tooltip-container">
        ...
        <div
          className="ability-icon ability"
          onClick={()=>{
            props.setAbility({name:"逆境強化", path:tenacity});
            }
          }
        >
          <div className="ability-tooltip-container">
        ...
        <div
          className="ability-icon ability"
          onClick={()=>{
            props.setAbility({name:"カムバック", path:comeback});
            }
          }
        >
          <div className="ability-tooltip-container">
